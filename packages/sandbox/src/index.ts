...
self.MonacoEnvironment = {
  getWorker: function (workerId, label): Worker {
      const getWorkerModule = (moduleUrl: string | URL, label: string) => {
...
export type SandboxConfig = {
  ...
  monacoSettings?: import("monaco-editor/esm/vs/editor/editor.api").editor.IEditorOptions
...
const sharedEditorOptions: import("monaco-editor/esm/vs/editor/editor.api").editor.IEditorOptions = {
...
function createFileUri(config: SandboxConfig, compilerOptions: CompilerOptions) {
  return monaco.Uri.file(defaultFilePath(config, compilerOptions))
}
...
export const createTypeScriptSandbox = (
  ...
  // Defaults
  const compilerDefaults = getDefaultSandboxCompilerOptions(config)
