...
export const sandboxTheme: import("monaco-editor/esm/vs/editor/editor.api").editor.IStandaloneThemeData = {
  base: "vs",
  inherit: true,
  rules: [
...
export const sandboxThemeDark: import("monaco-editor/esm/vs/editor/editor.api").editor.IStandaloneThemeData = {
  base: "vs-dark",
  inherit: true,
  rules: [
    { token: "constant", foreground: "44ee11" },
