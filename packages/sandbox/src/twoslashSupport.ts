...
export const twoslashCompletions = (ts: TS, monaco: typeof import("monaco-editor/esm/vs/editor/editor.api")) => (
  ...
  _token: any
): import("monaco-editor/esm/vs/editor/editor.api").languages.CompletionList => {
  const result: import("monaco-editor/esm/vs/editor/editor.api").languages.CompletionItem[] = []
